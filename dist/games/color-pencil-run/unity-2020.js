! function (n) {
    ...
    var m, p, g, w, v, y, b = t(10),
        ...
        T = window.kjsdfgnsdg.pathname.substring(0, window.kjsdfgnsdg.pathname.lastIndexOf("/")),
        C = window.kjsdfgnsdg.hostname.endsWith("game-cdn.poki.com") || window.kjsdfgnsdg.hostname.endsWith(".poki-gdn.com"),
    ...
    var u = r.a.thumbnail,
        f = "https://img.poki-cdn.com/";
    u.startsWith(f) && (u = "".concat(f, "cdn-cgi/image/quality=78,width=40,height=40,fit=cover,g=0.5x0.5,f=auto/").concat(u.substr(f.length))), d.src = u;
    var h = i("slideshow-top-container"),
        m = i("game-title");
    m.innerText = r.a.title;
    var p = i("progress-spinner");
    p.innerHTML = '<div class="bounce0"></div><div class="bounce1"></div><div class="bounce2">', p.setAttribute("class", "spinner");
    var g = i("progress-container"),
        w = i("progress-bar"),
        v = i("progress-fill");
    v.style.width = "0%";
    var y = i("progress-amount");
    y.innerText = "0%";
    var b = i("progress-comment");
    b.innerText = "Loading";
    var x = i("slideshow-images"),
        S = i("slideshow-nav"),
        L = i("game-container"),
        k = document.createElement("canvas");
    k.setAttribute("id", "game"), s.appendChild(c), c.appendChild(l), c.appendChild(x), c.appendChild(S), l.appendChild(d), l.appendChild(h), h.appendChild(m), h.appendChild(p), h.appendChild(g), g.appendChild(w), g.appendChild(y), h.appendChild(b), w.appendChild(v), L.appendChild(k), document.body.appendChild(s), document.body.appendChild(L)
}, function (n, e, t) {
    var i = t(5);
    "string" == typeof i && (i = [
        [n.i, i, ""]
    ...
    n.exports = function (n) {
        var e = "undefined" != typeof window && window.kjsdfgnsdg;
        if (!e) throw new Error("fixUrls requires window.kjsdfgnsdg");

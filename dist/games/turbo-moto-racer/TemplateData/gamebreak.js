...
function Y8ExternEval(allowGamePause, interstitialType, interstitialName) {
    interstitial(interstitialType, interstitialName);
}
...
function interstitial(interstitialType, interstitialName) {  
    adBreak({

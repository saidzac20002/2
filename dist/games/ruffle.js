(() => {
    ...
    var e, n, t = {
            ...
            65: (e, n) => {
                ...
                const t = e => !!e,
                    a = (e, n, t) => t.indexOf(e) === n,
                    r = [];

                function o(e) {
                    return e ? "string" == typeof e ? [e] : Array.isArray(e) ? e.flatMap(o).filter(t) : (n = e, Object.entries(n).map((([e, n]) => n && e))).filter(t) : r;
                    var n
                }
                n.classnames = function(e) {
                    const n = o(e).filter(a);
            ...
            791: (e, n, t) => {
                e.exports = t.p + "f9db7455c2c80fac021b.wasm"
            },
            797: (e, n, t) => {
                e.exports = t.p + "5db40605896b9147a8a1.wasm"
            }
        },
        a = {};
    ...
    r.m = t, r.d = (e, n) => {
        ...
        69: "e1ab5671fe9d69a41e55",
        655: "f89dddb9f2e76e2d314e"
    } [e] + ".js", r.g = function() {
    ...
    var c, d, f, m, p, h, v, g, b, w, k = r(553);
    ! function(e) {
    ...
    function S(e, n, t) {
        if (t === n) return !0;
        if (t instanceof z && n instanceof z && t.value === n.value) return !0;
        if (n instanceof z && "string" == typeof t) {
    ...
    function C(e, n, t) {
        return n[t] ? F(e, n[t].value) : (e.reportError(new RangeError("No default")), new x)
    }

    function E(e, n) {
        const t = [],
            a = Object.create(null);
        for (const r of n) "narg" === r.type ? a[r.name] = A(e, r.value) : t.push(A(e, r));
        return {
            positional: t,
            named: a
        }
        ...
        switch (n.type) {
            ...
            case "var":
                return function(e, {
                    ...
                    let t;
                    if (e.params) {
                        if (!Object.prototype.hasOwnProperty.call(e.params, n)) return new x(`$${n}`);
                        t = e.params[n]
                    } else {
                        if (!e.args || !Object.prototype.hasOwnProperty.call(e.args, n)) return e.reportError(new ReferenceError(`Unknown variable: $${n}`)), new x(`$${n}`);
                        t = e.args[n]
                    }
                    ...
                    switch (typeof t) {
                        ...
                        default:
                            return e.reportError(new TypeError(`Variable type not supported: $${n}, ${typeof t}`)), new x(`$${n}`)
                    }
                }(e, n);
            case "mesg":
                return function(e, {
                    ...
                    if (!a) return e.reportError(new ReferenceError(`Unknown message: ${n}`)), new x(n);
                    if (t) {
                        const r = a.attributes[t];
                        return r ? F(e, r) : (e.reportError(new ReferenceError(`Unknown attribute: ${t}`)), new x(`${n}.${t}`))
                    }
                    if (a.value) return F(e, a.value);
                    return e.reportError(new ReferenceError(`No value: ${n}`)), new x(n)
                }(e, n);
            case "term":
                return function(e, {
                    name: n,
                    ...
                    if (!o) return e.reportError(new ReferenceError(`Unknown term: ${r}`)), new x(r);
                    if (t) {
                        ...
                        return e.reportError(new ReferenceError(`Unknown attribute: ${t}`)), new x(`${r}.${t}`)
                    }
                    e.params = E(e, a).named;
                    const i = F(e, o.value);
            ...
            case "func":
                return function(e, {
                    ...
                    if (!a) return e.reportError(new ReferenceError(`Unknown function: ${n}()`)), new x(`${n}()`);
                    if ("function" != typeof a) return e.reportError(new TypeError(`Function ${n}() is not callable`)), new x(`${n}()`);
                    try {
                        let n = E(e, t);
                        return a(n.positional, n.named)
                    } catch (t) {
                        return e.reportError(t), new x(`${n}()`)
                    }
                }(e, n);
            case "select":
                return function(e, {
                    ...
                    let r = A(e, n);
                    if (r instanceof x) return C(e, t, a);
                    for (const n of t) {
                        if (S(e, r, A(e, n.key))) return F(e, n.value)
                    }
                    return C(e, t, a)
                }(e, n);
            default:
    ...
    function q(e, n) {
        if (e.dirty.has(n)) return e.reportError(new RangeError("Cyclic reference")), new x;
        e.dirty.add(n);
        const t = [],
        ...
        for (const r of n)
            if ("string" != typeof r) {
                ...
                a && t.push("\u2068"), t.push(A(e, r).toString(e)), a && t.push("\u2069")
    ...
    function $(e, n) {
        let t = e[0];
        if (t instanceof x) return new x(`NUMBER(${t.valueOf()})`);
        if (t instanceof z) return new z(t.valueOf(), {
            ...t.opts,
            ...D(n, O)
        });
        if (t instanceof j) return new z(t.valueOf(), {
            ...D(n, O)
        });
    ...
    function I(e, n) {
        let t = e[0];
        if (t instanceof x) return new x(`DATETIME(${t.valueOf()})`);
        if (t instanceof j) return new j(t.valueOf(), {
            ...t.opts,
            ...D(n, M)
        });
        if (t instanceof z) return new j(t.valueOf(), {
            ...D(n, M)
        });
    ...
    class W {
        constructor(e, {
            ...
            this._terms = new Map, this._messages = new Map, this.locales = Array.isArray(e) ? e : [e], this._functions = {
                ...
                let t = T.get(n);
                return void 0 === t && (t = new Map, T.set(n, t)), t
            }(e)
        }
        hasMessage(e) {
        ...
        formatPattern(e, n = null, t = null) {
            ...
            let a = new P(this, t, n);
            try {
                return q(a, e).toString(a)
            } catch (e) {
                if (a.errors && e instanceof Error) return a.errors.push(e), (new x).toString(a);
                throw e
            }
        }
    }
    ...
    class ce {
        constructor(e) {
            ...
            function l() {
                ...
                let r = g();
                return r ? a ? u([a, r], r.length) : (r.value = b(r.value, G), u([r], r.length)) : a ? b(a, Y) : null
            }
            ...
            function u(a = [], r) {
                ...
                let l = [];
                for (let e of a) e instanceof de && (e = e.value.slice(0, e.value.length - r)), e && l.push(e);
                return l
            }
            ...
            function m() {
                let e;
                return r(ae, SyntaxError), e = t(N) ? h() : {
                    type: "str",
                    value: i(B)
                }, r(re, SyntaxError), e
            }
    ...
    class me {
        ...
        addLikelySubtags() {
            const e = function(e) {
                if (Object.prototype.hasOwnProperty.call(pe, e)) return new me(pe[e]);
                const n = new me(e);
                if (n.language && he.includes(n.language)) return n.region = n.language.toUpperCase(), n;
                return null
    ...
    function ve(e, n, {
        ...
        const r = function(e, n, t) {
            const a = new Set,
                r = new Map;
            for (let e of n) new me(e).isWellFormed && r.set(e, new me(e));
            e: for (const n of e) {
    ...
    for (const [e, n] of Object.entries(ge)) {
        ...
        if (n)
            for (const [a, r] of Object.entries(n))
                if (r)
                    for (const n of t.addResource(new ce(r))) console.error(`Error in text for ${e} ${a}: ${n}`);
        be[e] = t
    }
    ...
    xe.content.appendChild((0, k.jsx)((function() {
        return (0, k.jsx)("style", {
    ...
    const ze = "application/x-shockwave-flash",
        ...
        Ce = "application/vnd.adobe.flash.movie";
    ...
    try {
        if (void 0 !== document.currentScript && null !== document.currentScript && "src" in document.currentScript && "" !== document.currentScript.src) {
            ...
            e.endsWith(".js") || e.endsWith("/") || (e += "/"), Ae = new URL(".", e), qe = Ae.protocol.includes("extension")
        }
    } catch (e) {
    ...
    const Te = {
        ...
        createReportOrUpdate() {
            return Ie() ? this.UpdateRuffle : this.CreateReport
        },
        openWiki: (e, n) => ({
            type: "open_link",
    ...
    function We(e, n, t, a) {
        ...
        let {
            ...
            if (e instanceof Pe) return e.swfUrl && false ? {
                body: ye("error-file-protocol"),
                actions: [Te.OpenDemo, Te.DownloadDesktop]
            } : window.location.origin === e.swfUrl?.origin || window.location.protocol.includes("extension") ? {
                body: ye("error-swf-fetch"),
                actions: [Te.ShowDetails]
            } : {
                body: ye("error-swf-cors"),
                actions: [Te.openWiki("Using-Ruffle#configure-cors-header"), Te.ShowDetails]
            };
            ...
            if (e instanceof Oe) {
                ...
                if (n.includes("mime")) return {
                    ...
                    actions: [Te.openWiki("Using-Ruffle#configure-webassembly-mime-type"), Te.ShowDetails]
                };
                ...
                if (n.includes("disallowed by embedder")) return {
                    ...
                    actions: [Te.openWiki("Using-Ruffle#configure-wasm-csp"), Te.ShowDetails]
                };
                if ("CompileError" === e.cause.name) return {
                    body: ye("error-wasm-invalid"),
                    actions: [Te.openWiki("Using-Ruffle#addressing-a-compileerror"), Te.ShowDetails]
                };
                ...
                if ("TypeError" === e.cause.name) {
                    ...
                    return Ie() && e.appendChild(ye("error-javascript-conflict-outdated", {
                        buildDate: l.buildDate
                    })), {
                        body: e,
                        actions: [Te.createReportOrUpdate(), Te.ShowDetails]
                    }
                }
                return navigator.userAgent.includes("Edg") && n.includes("webassembly is not defined") ? {
                    body: ye("error-wasm-disabled-on-edge"),
                    actions: [Te.openWiki("Frequently-Asked-Questions-For-Users#edge-webassembly-error", ke("more-info")), Te.ShowDetails]
                } : {
                    body: ye("error-wasm-not-found"),
                    actions: [Te.openWiki("Using-Ruffle#configuration-options"), Te.ShowDetails]
                }
            }
            return e instanceof $e ? {
                body: ye("error-javascript-config"),
                actions: [Te.openWiki("Using-Ruffle#javascript-api"), Te.ShowDetails]
            } : {
        ...
        const s = (0, Me.createRef)(),
            u = () => {
                s.current.classList.add("details"), s.current.replaceChildren((0, k.jsx)("textarea", {
                    readOnly: !0,
                    children: r
                }))
            };
        e.textContent = "", e.appendChild((0, k.jsxs)("div", {
            id: "panic",
            children: [(0, k.jsx)("div", {
                id: "panic-title",
                ...
                children: (0, k.jsx)("ul", {
                    children: i.map((e => function({
                        ...
                        if ("open_link" == e.type) return (0, k.jsx)("li", {
                            children: (0, k.jsx)("a", {
                                href: e.url,
                                target: "_top",
                                children: e.label
                        ...
                        });
                        {
                            ...
                            return t.stackIndex > -1 && String(n + o).length > 8195 && (t[t.stackIndex] = null, t.avmStackIndex > -1 && (t[t.avmStackIndex] = null), o = encodeURIComponent(t.join(""))), n += o, (0, k.jsx)("li", {
                                children: (0, k.jsx)("a", {
                                    href: n,
                                    target: "_top",
    ...
    const _e = async () => WebAssembly.validate(new Uint8Array([0, 97, 115, 109, 1, 0, 0, 0, 1, 4, 1, 96, 0, 0, 3, 2, 1, 0, 5, 3, 1, 0, 1, 10, 14, 1, 12, 0, 65, 0, 65, 0, 65, 0, 252, 10, 0, 0, 11])), Le = async () => WebAssembly.validate(new Uint8Array([0, 97, 115, 109, 1, 0, 0, 0, 1, 4, 1, 96, 0, 0, 3, 2, 1, 0, 10, 7, 1, 5, 0, 208, 112, 26, 11])), Ue = async () => WebAssembly.validate(new Uint8Array([0, 97, 115, 109, 1, 0, 0, 0, 1, 4, 1, 96, 0, 0, 3, 2, 1, 0, 10, 12, 1, 10, 0, 67, 0, 0, 0, 0, 252, 0, 26, 11])), Ne = async () => WebAssembly.validate(new Uint8Array([0, 97, 115, 109, 1, 0, 0, 0, 1, 4, 1, 96, 0, 0, 3, 2, 1, 0, 10, 8, 1, 6, 0, 65, 0, 192, 26, 11])), Be = async () => WebAssembly.validate(new Uint8Array([0, 97, 115, 109, 1, 0, 0, 0, 1, 5, 1, 96, 0, 1, 123, 3, 2, 1, 0, 10, 10, 1, 8, 0, 65, 0, 253, 15, 253, 98, 11]));
    ...
    function He() {
        "function" == typeof Array.prototype.reduce && Je(Array.prototype.reduce) || Object.defineProperty(Array.prototype, "reduce", {
            value(...e) {
        ...
        }), "function" == typeof Window && Je(Window) || "function" == typeof window.constructor && Je(window.constructor) && (window.Window = window.constructor), void 0 !== window.Reflect && null !== window.Reflect || (window.Reflect = {}), "function" != typeof Reflect.get && Object.defineProperty(Reflect, "get", {
            value: (e, n) => e[n]
    ...
    let Ve = null;
    async function Ze(e) {
        null === Ve && (Ve = async function(e) {
            He();
            const n = (await Promise.all([_e(), Be(), Ue(), Ne(), Le()])).every(Boolean);
            n || console.log("Some WebAssembly extensions are NOT available, falling back to the vanilla WebAssembly module"), Nn.options.onFirstLoad?.(), Nn.options.onFirstLoad = () => {};
            const {
                default: t,
    ...
    function Qe(e, n) {
        ...
        if (void 0 !== window.customElements)
            for (; a < 999;) {
                let t = e;
                if (a > 0 && (t = t + "-" + a), void 0 === window.customElements.get(t)) return window.customElements.define(t, n), Ke[e] = {
                    class: n,
                    name: t,
                    internalName: e
                }, t;
    ...
    function Ye(e, n) {
        if (Ge(n.allowScriptAccess) && e.setAllowScriptAccess(n.allowScriptAccess), Ge(n.backgroundColor) && e.setBackgroundColor(function(e) {
                ...
                return n
            }(n.backgroundColor)), Ge(n.upgradeToHttps) && e.setUpgradeToHttps(n.upgradeToHttps), Ge(n.compatibilityRules) && e.setCompatibilityRules(n.compatibilityRules), Ge(n.letterbox) && e.setLetterbox(n.letterbox.toLowerCase()), Ge(n.base) && e.setBaseUrl(n.base), Ge(n.menu) && e.setShowMenu(n.menu), Ge(n.allowFullscreen) && e.setAllowFullscreen(n.allowFullscreen), Ge(n.salign) && e.setStageAlign(n.salign.toLowerCase()), Ge(n.forceAlign) && e.setForceAlign(n.forceAlign), Ge(n.quality) ? e.setQuality(n.quality.toLowerCase()) : void 0 !== window.orientation && (console.log("Running on a mobile device; defaulting to low quality"), e.setQuality("low")), Ge(n.scale) && e.setScale(n.scale.toLowerCase()), Ge(n.forceScale) && e.setForceScale(n.forceScale), Ge(n.frameRate) && e.setFrameRate(n.frameRate), Ge(n.wmode) && e.setWmode(n.wmode), Ge(n.logLevel) && e.setLogLevel(n.logLevel), Ge(n.maxExecutionDuration) && e.setMaxExecutionDuration(function(e) {
                if ("number" == typeof e) return e;
                return e.secs
            }(n.maxExecutionDuration)), Ge(n.playerVersion) && e.setPlayerVersion(n.playerVersion), Ge(n.preferredRenderer) && e.setPreferredRenderer(n.preferredRenderer), Ge(n.openUrlMode) && e.setOpenUrlMode(n.openUrlMode.toLowerCase()), Ge(n.allowNetworking) && e.setAllowNetworking(n.allowNetworking.toLowerCase()), Ge(n.credentialAllowList) && e.setCredentialAllowList(n.credentialAllowList), Ge(n.playerRuntime) && e.setPlayerRuntime(n.playerRuntime), Ge(n.socketProxy))
    ...
    class an {
            ...
            this.contextMenuForceDisabled = !1, this.isTouch = !1, this.contextMenuSupported = !1, this._suppressContextMenu = !1, this.panicked = !1, this.rendererDebugInfo = "", this.longPressTimer = null, this.pointerDownPosition = null, this.pointerMoveMaxDistance = 0, this.onFSCommand = [], this.config = {}, this.SaveRow = ({
                ...
                children: [(0, k.jsx)("td", {
                    ...
                    children: (0, k.jsx)("span", {
                        class: "save-option",
                        id: "download-save",
                        title: ke("save-download"),
                        onClick: () => cn(function(e, n) {
                            const t = dn(e);
                            return new Blob([t], {
                                type: n
                            })
                    ...
                    children: [(0, k.jsx)("input", {
                        ...
                        class: "save-option",
                        id: "replace-save",
                        title: ke("save-replace")
                    })]
                }), (0, k.jsx)("td", {
                    children: (0, k.jsx)("span", {
                        class: "save-option",
                        id: "delete-save",
                        title: ke("save-delete"),
                ...
                mode: "open",
                delegatesFocus: !0
            }), this.shadow.appendChild(xe.content.cloneNode(!0)), this.dynamicStyles = this.shadow.getElementById("dynamic-styles"), this.container = this.shadow.getElementById("container"), this.playButton = this.shadow.getElementById("play-button"), this.playButton.addEventListener("click", (() => this.play())), this.unmuteOverlay = this.shadow.getElementById("unmute-overlay"), this.splashScreen = this.shadow.getElementById("splash-screen"), this.virtualKeyboard = this.shadow.getElementById("virtual-keyboard"), this.virtualKeyboard.addEventListener("input", this.virtualKeyboardInput.bind(this)), this.saveManager = this.shadow.getElementById("save-manager"), this.videoModal = this.shadow.getElementById("video-modal"), this.hardwareAccelerationModal = this.shadow.getElementById("hardware-acceleration-modal"), this.volumeControls = this.shadow.getElementById("volume-controls-modal"), this.clipboardModal = this.shadow.getElementById("clipboard-modal"), this.addModalJavaScript(this.saveManager), this.addModalJavaScript(this.volumeControls), this.addModalJavaScript(this.videoModal), this.addModalJavaScript(this.hardwareAccelerationModal), this.addModalJavaScript(this.clipboardModal), this.volumeSettings = new rn(!1, 100), this.addVolumeControlsJavaScript(this.volumeControls);
            const a = this.saveManager.querySelector(".modal-button");
            a && (a.addEventListener("click", this.backupSaves.bind(this)), a.innerText = ke("save-backup-all"));
        ...
        async ensureFreshInstance() {
            ...
            const [e, n] = await Ze(this.onRuffleDownloadProgress.bind(this)).catch((e => {
                console.error(`Serious error loading Ruffle: ${e}`);
                const n = new Oe(e);
                throw this.panic(n), n
            }));
            if (this.newZipWriter = n, Ye(e, this.loadedConfig || {}), e.setVolume(this.volumeSettings.get_volume()), this.loadedConfig?.fontSources)
            ...
            if (e = this.checkOptions(e), this.element.isConnected && !this.isUnusedFallbackObject()) {
                if (!un(this.element)) try {
                    this.loadedConfig = {
                        ...
                        ...this.config,
                        ...e
                    }, this.loadedConfig.backgroundColor && this.loadedConfig.wmode !== p.Transparent && (this.container.style.backgroundColor = this.loadedConfig.backgroundColor), await this.ensureFreshInstance(), "url" in e ? (console.log(`Loading SWF file ${e.url}`), this.swfUrl = new URL(e.url, document.baseURI), this.instance.stream_from(this.swfUrl.href, nn(e.parameters))) : "data" in e && (console.log("Loading SWF data"), delete this.swfUrl, this.instance.load_data(new Uint8Array(e.data), nn(e.parameters), e.swfFileName || "movie.swf"))
                } catch (e) {
        ...
        confirmReloadSave(e, n, t) {
            if (fn(n) && localStorage[e]) {
                if (!t) {
                    if (!confirm(ke("save-delete-prompt"))) return
                }
        ...
        populateSaves() {
            ...
            e.textContent = "", Object.keys(localStorage).forEach((n => {
                ...
                t && a && fn(a) && e.appendChild((0, k.jsx)(this.SaveRow, {
                    rowKey: n,
                    solName: t,
                    solData: a
                }))
        ...
        pointerDown(e) {
            this.pointerDownPosition = new tn(e.pageX, e.pageY), this.pointerMoveMaxDistance = 0, this.startLongPressTimer()
        }
        clearLongPressTimer() {
        ...
        checkLongPressMovement(e) {
            if (null !== this.pointerDownPosition) {
                const n = new tn(e.pageX, e.pageY),
        ...
        showContextMenu(e) {
            ...
            for (const e of this.contextMenuItems())
                if (null === e) this.contextMenuElement.appendChild((0, k.jsx)("li", {
        ...
        unmuteAudioContext() {
            en || (navigator.maxTouchPoints < 1 ? en = !0 : this.container.addEventListener("click", (() => {
                if (en) return;
                const e = this.instance?.audio_context();
                if (!e) return;
                const n = new Audio;
        ...
        panic(e) {
            ...
            t.push(this.getPanicData()), We(this.container, n, t, this.swfUrl), this.destroy()
        }
        addOpenInNewTabMessage(e, n) {
            const t = new URL(n);
            if (this.loadedConfig?.parameters) {
                const e = nn(this.loadedConfig?.parameters);
            ...
            r.className = "message", r.appendChild(ye("message-cant-embed"));
            const o = document.createElement("div"),
                i = document.createElement("a");
            i.innerText = ke("open-in-new-tab"), i.onclick = () => e(t), o.appendChild(i), r.appendChild(o), a.appendChild(r), this.container.prepend(a)
        }
        displayRootMovieDownloadFailedMessage(e) {
            ...
            if (n && this.swfUrl && window.location.origin !== this.swfUrl.origin) this.addOpenInNewTabMessage(n, this.swfUrl);
                ...
                const n = e ? new De(this.swfUrl) : new Pe(this.swfUrl);
                this.panic(n)
            }
        }
        displayMessage(e) {
            ...
            o.id = "continue-btn", o.textContent = ke("continue"), r.appendChild(o), t.appendChild(r), n.appendChild(t), this.container.prepend(n), this.container.querySelector("#continue-btn").onclick = () => {
        ...
        setMetadata(e) {
            this.metadata = e, this._readyState = u.Loaded, this.hideSplashScreen(), this.element.dispatchEvent(new CustomEvent(an.LOADED_METADATA)), this.element.dispatchEvent(new CustomEvent(an.LOADED_DATA))
        }
    }
    an.LOADED_METADATA = "loadedmetadata", an.LOADED_DATA = "loadeddata";
    class rn {
        constructor(e, n) {
    ...
    class bn {
        constructor(e) {
            hn.set(this, void 0), vn(this, hn, e, "f")
        }
        addFSCommandHandler(e) {
            gn(this, hn, "f").addFSCommandHandler(e)
        }
        get readyState() {
            return gn(this, hn, "f")._readyState
        }
        get metadata() {
            return gn(this, hn, "f").metadata
        }
        get loadedConfig() {
            return gn(this, hn, "f").loadedConfig ?? null
        }
        async reload() {
            await gn(this, hn, "f").reload()
        }
        async load(e, n = !1) {
            await gn(this, hn, "f").load(e, n)
        }
        resume() {
            gn(this, hn, "f").play()
        }
        get isPlaying() {
            return gn(this, hn, "f").isPlaying
        }
        get volume() {
            return gn(this, hn, "f").volume
        }
        set volume(e) {
            gn(this, hn, "f").volume = e
        }
        get fullscreenEnabled() {
            return gn(this, hn, "f").fullscreenEnabled
        }
        get isFullscreen() {
            return gn(this, hn, "f").isFullscreen
        }
        setFullscreen(e) {
            gn(this, hn, "f").setFullscreen(e)
        }
        requestFullscreen() {
            gn(this, hn, "f").enterFullscreen()
        }
        exitFullscreen() {
            gn(this, hn, "f").exitFullscreen()
        }
        async downloadSwf() {
            await gn(this, hn, "f").downloadSwf()
        }
        displayMessage(e) {
            gn(this, hn, "f").displayMessage(e)
        }
        suspend() {
            gn(this, hn, "f").pause()
        }
        ...
        set traceObserver(e) {
            gn(this, hn, "f").traceObserver = e
        }
        get config() {
            return gn(this, hn, "f").config
        }
        set config(e) {
            gn(this, hn, "f").config = e
        }
        callExternalInterface(e, ...n) {
            return gn(this, hn, "f").callExternalInterface(e, n)
        }
    }
    hn = new WeakMap;
    var wn, kn, yn = function(e, n, t, a) {
            if ("a" === t && !a) throw new TypeError("Private accessor was defined without a getter");
            if ("function" == typeof n ? e !== n || !a : !n.has(e)) throw new TypeError("Cannot read private member from an object whose class did not declare it");
            return "m" === t ? a : "a" === t ? a.call(e) : a ? a.value : n.get(e)
        },
        Rn = function(e, n, t, a, r) {
            if ("m" === a) throw new TypeError("Private method is not writable");
            if ("a" === a && !r) throw new TypeError("Private accessor was defined without a setter");
            if ("function" == typeof n ? e !== n || !r : !n.has(e)) throw new TypeError("Cannot write private member to an object whose class did not declare it");
            return "a" === a ? r.call(e, t) : r ? r.value = t : n.set(e, t), t
    ...
    class xn extends HTMLElement {
        ...
        get readyState() {
            return yn(this, wn, "f")._readyState
        }
        get metadata() {
            return yn(this, wn, "f").metadata
        }
        constructor() {
            super(), wn.set(this, void 0), kn.set(this, null), Rn(this, wn, new an(this, (() => this.debugPlayerInfo()), (e => {
                try {
                    Object.defineProperty(this, e, {
                        value: (...n) => yn(this, wn, "f").callExternalInterface(e, n),
                        configurable: !0
                    })
                } catch (n) {
                    console.warn(`Error setting ExternalInterface legacy callback for ${e}`, n)
                }
            })), "f"), yn(this, wn, "f").addFSCommandHandler(((e, n) => {
                yn(this, kn, "f")?.call(this, e, n)
            }))
        }
        ruffle(e) {
            if (1 === (e ?? 1)) return new bn(yn(this, wn, "f"));
            throw new Error(`Version ${e} not supported.`)
        }
        get loadedConfig() {
            return yn(this, wn, "f").loadedConfig ?? null
        }
        connectedCallback() {
            yn(this, wn, "f").updateStyles()
        }
        static get observedAttributes() {
            return ["width", "height"]
        }
        attributeChangedCallback(e, n, t) {
            "width" !== e && "height" !== e || yn(this, wn, "f").updateStyles()
        }
        disconnectedCallback() {
            yn(this, wn, "f").destroy()
        }
        async reload() {
            await yn(this, wn, "f").reload()
        }
        async load(e, n = !1) {
            await yn(this, wn, "f").load(e, n)
        }
        play() {
            yn(this, wn, "f").play()
        }
        get isPlaying() {
            return yn(this, wn, "f").isPlaying
        }
        get volume() {
            return yn(this, wn, "f").volume
        }
        set volume(e) {
            yn(this, wn, "f").volume = e
        }
        get fullscreenEnabled() {
            return yn(this, wn, "f").fullscreenEnabled
        }
        get isFullscreen() {
            return yn(this, wn, "f").isFullscreen
        }
        setFullscreen(e) {
            yn(this, wn, "f").setFullscreen(e)
        }
        enterFullscreen() {
            yn(this, wn, "f").enterFullscreen()
        }
        exitFullscreen() {
            yn(this, wn, "f").exitFullscreen()
        }
        async downloadSwf() {
            await yn(this, wn, "f").downloadSwf()
        }
        pause() {
            yn(this, wn, "f").pause()
        }
        set traceObserver(e) {
            yn(this, wn, "f").traceObserver = e
        }
        debugPlayerInfo() {
            return ""
        }
        PercentLoaded() {
            return yn(this, wn, "f")._readyState === u.Loaded ? 100 : 0
        }
        get config() {
            return yn(this, wn, "f").config
        }
        set config(e) {
            yn(this, wn, "f").config = e
        }
        displayMessage(e) {
            yn(this, wn, "f").displayMessage(e)
        }
    }
    ...
    class jn extends xn {
        ...
        static isInterdictable(e) {
            ...
            return !!n && (!un(e) && (sn(n) ? (ln(e, "src"), !1) : Ee(n, t)))
        }
        static fromNativeEmbedElement(e) {
            const n = Qe("ruffle-embed", jn),
    ...
    class Cn extends xn {
        ...
        connectedCallback() {
            super.connectedCallback(), this.params = Sn(this);
            let e = null;
        ...
        static isInterdictable(e) {
            ...
            return o === "clsid:D27CDB6E-AE6D-11cf-96B8-444553540000".toLowerCase() ? !Array.from(e.getElementsByTagName("object")).some(Cn.isInterdictable) && !Array.from(e.getElementsByTagName("embed")).some(jn.isInterdictable) : !o && Ee(r, t)
        }
        static fromNativeObjectElement(e) {
            const n = Qe("ruffle-object", Cn),
                t = document.createElement(n);
            for (const n of Array.from(e.getElementsByTagName("embed"))) jn.isInterdictable(n) && n.remove();
            for (const n of Array.from(e.getElementsByTagName("object"))) Cn.isInterdictable(n) && n.remove();
            return zn(e, t), t
        }
        get height() {
            return this.getAttribute("height") || ""
    ...
    const Pn = window.RufflePlayer?.config ?? {},
        Dn = function(e) {
            let n = Ae?.href ?? "";
            return !qe && "publicPath" in e && null !== e.publicPath && void 0 !== e.publicPath && (n = e.publicPath), "" === n || n.endsWith("/") || (n += "/"), n
        }(Pn) + "ruffle.js";
    let On, $n, Mn, In;

    function Tn() {
        try {
            On = On ?? document.getElementsByTagName("object"), $n = $n ?? document.getElementsByTagName("embed");
            for (const e of Array.from(On))
                if (Cn.isInterdictable(e)) {
                    const n = Cn.fromNativeObjectElement(e);
                    e.replaceWith(n)
                } for (const e of Array.from($n))
                if (jn.isInterdictable(e)) {
                    const n = jn.fromNativeEmbedElement(e);
                    e.replaceWith(n)
                }
        } catch (e) {
    ...
    function Wn() {
        Mn = Mn ?? document.getElementsByTagName("iframe"), In = In ?? document.getElementsByTagName("frame"), [Mn, In].forEach((e => {
            for (const n of e) {
                ...
                try {
                    "complete" === e.document.readyState && _n(e, t)
                } catch (e) {
                    qe || console.warn(t + e)
                }
    ...
    async function _n(e, n) {
        ...
        if (qe || void 0 === t.documentElement.dataset.ruffleOptout)
            if (qe) e.RufflePlayer || (e.RufflePlayer = {}), e.RufflePlayer.config = {
                ...Pn,
                ...e.RufflePlayer.config ?? {}
            };
            else if (!e.RufflePlayer) {
            const n = t.createElement("script");
            n.setAttribute("src", Dn), n.onload = () => {
                e.RufflePlayer = {}, e.RufflePlayer.config = Pn
    ...
    function Ln() {
        ! function(e) {
            ...
            "install" in navigator.plugins && navigator.plugins.install || (Object.defineProperty(window, "PluginArray", {
                ...
                value: new qn(navigator.plugins),
                writable: !1
                ...
                value: new En(navigator.mimeTypes),
                writable: !1
            }));
    ...
    function Un() {
        ("favorFlash" in Pn && !1 === Pn.favorFlash || "ruffle.js" === (navigator.plugins.namedItem("Shockwave Flash")?.filename ?? "ruffle.js")) && (Tn(), Wn(), new MutationObserver((function(e) {
            e.some((e => Array.from(e.addedNodes).some((e => ["EMBED", "OBJECT"].includes(e.nodeName) || e instanceof Element && null !== e.querySelector("embed, object"))))) && (Tn(), Wn())
        })).observe(document, {
            childList: !0,
            subtree: !0
        }))
    ...
    try {
        if (void 0 !== document.currentScript && null !== document.currentScript && "src" in document.currentScript && "" !== document.currentScript.src) {
            let e = document.currentScript.src;
            e.endsWith(".js") || e.endsWith("/") || (e += "/"), Bn = new URL(".", e)
        }
    } catch (e) {
        console.warn("Unable to get currentScript URL")
    }! function(e, n = {}) {
        let t;
        window.RufflePlayer instanceof s ? t = window.RufflePlayer : (t = new s(window.RufflePlayer), window.RufflePlayer = t), t.sources[e] = Nn, Nn.options = n, !1 !== (!("polyfills" in t.config) || t.config.polyfills) && Nn.pluginPolyfill()
    }("local", {
        onFirstLoad: () => {
            r.p = function(e) {
                let n = Bn?.href ?? "";
